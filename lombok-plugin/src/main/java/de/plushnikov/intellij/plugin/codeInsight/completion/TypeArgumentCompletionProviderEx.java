 ...
 * @author peter
 */
public class TypeArgumentCompletionProviderEx extends CompletionProvider<CompletionParameters> {
    public static final ElementPattern<PsiElement> IN_TYPE_ARGS = psiElement().inside(PsiReferenceParameterList.class);
    ...
    public static class TypeArgsLookupElement extends LookupElement {
        ...
        public void handleInsert(InsertionContext context) {
            ...
            for (int i = 0; i < myTypeItems.size(); i++) {
                ...
                Method emulateInsertion = ReflectUtil.getMethod(CompletionUtil.class, InsertionContext.class, "emulateInsertion", InsertionContext.class, int.class, LookupElement.class);
                ReflectUtil.invokeMethod(emulateInsertion, context, context.getTailOffset(), typeItem);
    ...
    public void addTypeArgumentVariants(CompletionParameters parameters, Consumer<LookupElement> result, PrefixMatcher matcher) {
    ...
    private static boolean hasParameters(PsiTypeParameterListOwner paramOwner, PsiElement context) {
        return paramOwner instanceof PsiClass && hasConstructorParameters((PsiClass) paramOwner, context);
    }
